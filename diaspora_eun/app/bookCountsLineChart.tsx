  ...
  return (
    <div>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={ koreanPublicationData } margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" />
          <XAxis dataKey="year" />
          <YAxis />
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="count" stroke="#1F4C4C" activeDot={{ r: 8 }} />
        </LineChart>
      </ResponsiveContainer>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={transformedData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="koreanPublicationCount" stroke="#182C4B" activeDot={{ r: 8 }} />
          <Line type="monotone" dataKey="koreanHeritageCount" stroke="#941120" activeDot={{ r: 8 }} />
        </LineChart>
      </ResponsiveContainer>
      <Typography variant="subtitle2">
